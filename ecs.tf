...
data "template_file" "airflow_webserver_task_definition" {
  ...
  vars {
    image_url        = "cityofphiladelphia/airflow:0b8c356399d9e75b9500abc9ab2e406528a8a6e9"
...
data "template_file" "airflow_scheduler_task_definition" {
  ...
  vars {
    image_url        = "cityofphiladelphia/airflow:0b8c356399d9e75b9500abc9ab2e406528a8a6e9-v2"
